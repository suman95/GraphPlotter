...
public class Activity_sin extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        valT = getIntent().getFloatExtra("valT",0.0f);
        valP = getIntent().getFloatExtra("valP",0.0f);

        valP = ((float)Math.PI/180)*valP;
        ...
        for(int i=0;i<18001;i++){
            x[i]= (float)t;
            y[i]= (float)(valT*Math.sin(t+valP));
            t=t+0.001;
        }
